...
$pdf->startReport('Productos vendidos y monto recaudado', 
'El reporte muestra los productos y las ganancias recaudadas en sus ventas');
// Se instancia el módelo de Productos para procesar los datos.
$productos = new Productos;
// Se verifica si existen registros (productos) para mostrar, de lo contrario se imprime un mensaje.
if ($dataProductosV = $productos->reporteVentasRecaudacion()) {
    ...
    foreach ($dataProductosV as $rowProducto) {
        if ($contador % 2 == 0) {
