...
class Validator
{
    ...
    *   Retorno: booleano (true si el valor es correcto o false en caso contrario).
    */
    public function validarDinero($value)
    {
    ...
    */
    public function validatePassword($value)
    {
        ...
        if (strlen($value) >= 8) {
            ...
            if (strlen($value) <= 60) {
                //Array que guardará los caracteres especiales
                $caracteres_especiales = array('-', '*', '?', '!', '@', '#', '$', '(', ')', '.', ',');
                //Variable para saber si contiene un caracter
                $contiene = false;
                //Ciclo para ir validando si la contraseña ingresada contiene minimo 1 caracter especial
                for ($i = 0; $i < count($caracteres_especiales); $i++) {
                    if (strpos($value, $caracteres_especiales[$i]) !== false) {
                        //Cambiamos el valor a true de la variable, ya que la contraseña si contiene un caracter especial
                        $contiene = true;
                    }
                }
                ...
                if ($contiene == true) {
                    ...
                    $this->passwordError = 'La contraseña ingresada no contiene caracteres especiales ( - * ? ! @ # $ () . , )';
                    return false;
                }
            } else {
    ...
    *   Retorno: booleano (true si el valor es correcto o false en caso contrario).
    */
    public function validarDUI($value)
    {
    ...
    */
    ...
    //Metodo para guardar varias imagenes
