                        ...
                        switch (response.nivel_usuario) {
                            case 1:
                                menu_lateral += `
                                    ...
                                    <a onmouseout="CambiarImagen('salir2', 'cerrar_sesion.png')" onmouseover="CambiarImagen2('salir2', 'cerrar_sesion')" id="cerrar_sesion" onclick="logOut()" href="#"><img id="salir2" src="../../recursos/icons/cerrar_sesion.png" alt="Salir" onclick="logOut()">Cerrar Sesión</a>
                                `;
                                        ...
                                        <div id="boton_idioma">
                                            <div class="btn-group">
                                                ...
                                                <ul id="opciones" class="dropdown-menu">
                                                    <a class="dropdown-item btn-sm" id="idioma" data-toggle="tooltip" data-placement="left" data-html="true" href="../private/dashboard.html">English<img id="imagen_idioma" src="../../recursos/icons/england.png"></a>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul id="opciones" class="dropdown-menu">
                                                            <a class="dropdown-item btn-sm" id="idioma"
                                                                ...
                                                                href="../private/dashboard.html">English<img id="imagen_idioma"
                                            ...
                                            <li class="nav-item">
                                                <a onmouseout="CambiarImagen('salir', 'cerrar_sesion.png')"
                                                    ...
                                                    class="nav-link active" href="#" onclick="logOut()"><img id="salir"
                                                        src="../../recursos/icons/cerrar_sesion.png" alt="Salir">Cerrar
                                                    Sesión</a>
                                            </li>
                                        </ul>
                                    </div>
